...
class Blockchair implements Scanner {
  ...
  static const Map<String,String> defaultHeaders = {'User-Agent': "Dart bitcoin_bip44 library"};
  ...
  Future<bool> present(String address) async {
		var response = await http.get("$url/bitcoin/dashboards/address/$address", headers: defaultHeaders);
